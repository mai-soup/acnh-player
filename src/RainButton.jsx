...
const RainButton = ({ isActive, handleClick }) => {
  return (
    <button
      id="Rainy"
      onClick={handleClick}
    ...
    >
      <svg
        className={`w-12 h-12 ${
          isActive ? "stroke-acnh-blue" : "stroke-grey"
        } group-hover:stroke-grey transition-all duration-200`}
        viewBox="0 0 512 512"
      ...
      >
        ...
        <path
          ...
          style={rainStyles}
        />
        <line x1="144" y1="384" x2="112" y2="432" style={rainStyles} />
        <line x1="224" y1="384" x2="160" y2="480" style={rainStyles} />
        <line x1="304" y1="384" x2="272" y2="432" style={rainStyles} />
        <line x1="384" y1="384" x2="320" y2="480" style={rainStyles} />
      </svg>
    </button>
  );
};
